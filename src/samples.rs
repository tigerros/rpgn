...
use crate::{
    ...
    Eco, EcoCategory, MoveNumber, Pgn, PgnParseError, TurnsCapacity, Variation,
...
pub fn variation_sample0() -> Variation {
    let mut root_var = Variation::new(Chess::default(), TurnsCapacity::default());
...
pub fn pgn_sample3() -> PgnSample {
    ...
    PgnSample::new(
        PGN,
        Err(PgnParseError::SanError(VariationSanPlayError {
            turn_index: 1,
